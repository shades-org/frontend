import { DoNotDisturb, EventNote, Send, Videocam } from "@mui/icons-material";
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <ChatBubbleIncoming>
            I have a certain proposal for you. Are you interested?
          </ChatBubbleIncoming>
          <ChatBubbleOutgoing>
            Sure, I'd love to hear the details.
          </ChatBubbleOutgoing>
          ...
          <ChatBubbleOutgoing>
            Sounds interesting. Do you wish to discuss this in person?
          </ChatBubbleOutgoing>
          <ChatBubbleIncoming>Sure, time and place?</ChatBubbleIncoming>
          <ChatBubbleOutgoing>
            Letting you know as soon as possible.
          </ChatBubbleOutgoing>
        </Box>
        <TextInput />
      </Container>
